    ...
    methods (Access = private)
        ...
        function build_control_panel_(obj, cpw)
            ...
            obj.H.btn_mwf_enable = uicontrol(ctrl, 'Style', 'togglebutton', ...
                ...
                'BackgroundColor', [0.22 0.22 0.22], ...
                'ForegroundColor', [0.60 0.60 0.60], ...
                'Units', 'normalized', 'Position', [0.05 0.494 0.90 0.040], ...
        ...
        function s = status_text_(obj, headline, capturing)
            ...
            if capturing
                ...
                cap_line = sprintf('Capturing (%s)  ch %d  fs %d  N %d', ...
                                   src_lbl, obj.audio.n_hw_ch, ...
                                   cfg.fs, cfg.frame_size);
            else
                cap_line = sprintf('fs %d  frame %d', cfg.fs, cfg.frame_size);
            end
            ref = cfg.mwf.ref_mic;
            s = sprintf([ ...
                '%s\n' ...
                '%s\n' ...
                'Mics: %d (%s, %.0f cm)\n' ...
                'Drone AGL %.2f m   slant %.2f m\n' ...
                'g[s,d,e]@m%d = %.2f / %.2f / %.2f\n' ...
                'VAD %s'], ...
                headline, cap_line, ...
                cfg.n_mics, cfg.mic_geometry, cfg.mic_spacing*100, ...
                obj.geo.drone_agl, norm(obj.geo.pos_drone - obj.geo.pos_human), ...
